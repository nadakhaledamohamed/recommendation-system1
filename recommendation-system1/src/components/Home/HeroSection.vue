            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
               <div class="hero__content p-relative z-index-1">
                  <h3 class="hero__title">
                     ...
                     Books From Top Instructor.</h3>
                     <p>Meet Writers,and Instructors, who'll share their experience.</p>
                     <router-link to="/courses" class="e-btn">view all Books</router-link>
               </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
