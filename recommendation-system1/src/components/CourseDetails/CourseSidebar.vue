...
<div class="col-xxl-4 col-xl-4 col-lg-4">
   <div class="course__sidebar pl-70 p-relative">
      ...
      <div class="course__sidebar-widget-2 white-bg mb-20">
         <div class="course__video">
            ...
            <div class="course__enroll-btn">
               <div v-b-modal.modalEnroll class="e-btn e-btn-7 w-100">Enroll 
      ...
      <b-modal id="modalEnroll" centered title="Modal with Enroll" ok-only modal-footer="no"  modal-header="no">
         <div class="card p-5 text-center enrollMessage">
            <h2 class="mb-0">Successfully subscribed to the Book</h2>
         </div>
      </b-modal>
