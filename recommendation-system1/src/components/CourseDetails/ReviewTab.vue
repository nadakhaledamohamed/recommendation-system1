<template>
  <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
   <div class="course__review">
         ...
         <div class="row g-0">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
               <div class="course__review-rating-info grey-bg text-center">
                  ...
                  <p v-if="course.review">{{course.review.length}} Ratings</p>
               </div>
            </div>
      ...
      <div class="course__comment mb-75" v-if="course.review">
         <h3>{{course.review.length}} Comments</h3>

         <ul>
            <li v-for="(item, index) in course.review" :key="index">
               <div class="course__comment-box ">
                  <div class="course__comment-thumb float-start" v-if="item.user">
                     <img :src="item.user.image" :alt="item.user.name">
                  </div>
                  <div class="course__comment-content">
                     <div class="course__comment-wrapper ml-70 fix">
                        <div class="course__comment-info float-start" v-if="item.user">
