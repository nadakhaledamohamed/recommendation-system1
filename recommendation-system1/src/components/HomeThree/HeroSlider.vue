                    ...
                    <div class="row">
                        <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                            <div class="slider__content">
                                ...
                                <p>Meet Wirters,and cultural institutions, who'll share their experience.</p>
                                <router-link to="/about" class="e-btn slider__btn">Ready to Read?</router-link>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" :style="{background:'url('+ require(`@/assets/img/slider/slider-3.jpg`)+')'}">
                    ...
                    <div class="row">
                        <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                            <div class="slider__content">
                                <span>Learn & Achieve</span>
                                <h3 class="slider__title">Fundamentals of Algorithms <span class="yellow-bg">theory <img src="../../assets/img/shape/yellow-bg.png" alt=""> </span> Learn</h3>
                                <p>Meet Wirters,and cultural institutions, who'll share their experience.</p>
                                <router-link to="/about" class="e-btn slider__btn">Ready to Read?</router-link>
                            </div>
                        </div>
